        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden font-sans">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 text-sm font-medium">Create your WABABLAS account.</p>
                </div>

                {error && (
                    <div className="bg-red-50 text-red-600 p-3 rounded-xl text-xs font-medium border border-red-100 mb-6 text-center">
                        {error}
                    </div>
                )}
                ...
                <div className="mt-8 text-center space-y-4">
                    <p className="text-sm text-slate-600">
                        Have an account? <Link to="/login" className="text-blue-600 font-bold hover:text-blue-700">Log in</Link>
                    </p>
                </div>
            </motion.div>
